...
/* ── Color palette ──────────────────────────────────────────────────────────
   One cohesive direction: warm cream base, near-black ink, a single
   burnt-maroon accent that reads warm/rust rather than flat red.            */
...
export const SHADOWS = {
  card: "0 20px 50px rgba(21, 16, 13, 0.08)",
  panel: "0 30px 70px rgba(21, 16, 13, 0.09)",
  post: "0 40px 90px rgba(21, 16, 13, 0.11)",
  icon: "0 40px 90px rgba(154, 51, 36, 0.30)",
} as const;
