...
const SCENES: SampleScene[] = [
  {
    ...
    ...build(HookIntro, {
      variant: "process",
      duration: DURATION,
      sourceText: "Process wins. Every time.",
    }),
  },
  {
    id: "intro-pulse",
    ...build(IntroPulse, {
      duration: DURATION,
      sourceText: "Your story starts here.",
    }),
  },
  {
    id: "signal-ripple",
    ...build(SignalRipple, {
      variant: "heartbeat",
      duration: DURATION,
      sourceText: "Post. Pause. Post again.",
    }),
  },
  {
    id: "progress-ring",
    ...build(ProgressRing, {
      variant: "double-fill",
      duration: DURATION,
      sourceText: "Learning compounds every day.",
    }),
  },
  {
    id: "network-growth",
    ...build(NetworkGrowth, {
      variant: "inward",
      duration: DURATION,
      sourceText: "The audience finds you.",
    }),
  },
  {
    id: "icon-glow",
  ...
  },
  {
    ...
    ...build(PortfolioGrid, {
      duration: DURATION,
      sourceText: "The work speaks for itself.",
    }),
  },
  {
    id: "text-reveal",
    ...build(TextReveal, {
      variant: "centered",
      duration: DURATION,
      sourceText: "Most creators quit before compounding begins.",
    }),
  },
  {
    id: "bullet-list",
    ...build(BulletList, {
      variant: "checkmark",
      duration: DURATION,
      items: ["Show up daily.", "Ship small things.", "Let it compound."],
    }),
  },
  {
    id: "quote-card",
    ...build(QuoteCard, {
      duration: DURATION,
      quote: "Consistency is the only shortcut.",
  ...
  },
  {
    ...
    ...build(ComparisonSplit, {
      ...
      left: "GUESSING",
      right: "TESTING",
      sourceText: "Stop guessing, start testing.",
    }),
  },
  {
    id: "timeline",
  ...
  },
  {
    ...
    ...build(FlowConnector, {
      ...
      source: "POST",
      target: "GROWTH",
      sourceText: "One post leads to the next.",
    }),
  },
  {
    id: "stat-counter",
    ...build(StatCounter, {
      ...
      target: 1200,
      suffix: "+",
      sourceText: "readers in the first month",
    }),
  },
  {
    id: "bar-chart",
    ...build(BarChart, {
      duration: DURATION,
      data: [42, 60, 50, 78, 66, 96],
      sourceText: "Consistency beats intensity.",
    }),
  },
  {
    id: "line-chart",
    ...build(LineChart, {
      duration: DURATION,
      data: [18, 34, 28, 50, 42, 64, 58, 88],
      sourceText: "Up and to the right.",
    }),
  },
  {
    id: "image-frame",
    ...build(ImageFrame, {
      duration: DURATION,
      src: undefined,
      sourceText: "A screenshot of the real thing.",
    }),
  },
  {
    id: "code-block",
  ...
  },
  {
    ...
    ...build(MaskReveal, {
      duration: DURATION,
      sourceText: "What comes next...",
    }),
  },
];

export const yourSceneDuration =
